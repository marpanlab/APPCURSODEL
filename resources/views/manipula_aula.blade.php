                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                          <form method="POST" action="{{ route('delete_aula', $registrosAulas->id) }}">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger" onclick="return confirm('Tem certeza que deseja deletar esta aula?')">
